package com.example.nucleofornari.presentation.screen.professor.relatorio
...
@Composable
fun ListaDeAlunosComData(state: UiState<List<com.example.nucleofornari.domain.model.aluno.AlunoResponseDto>>, viewModel: RelatorioProfessorViewModel) {
