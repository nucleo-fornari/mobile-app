...
import com.example.nucleofornari.presentation.common.component.WhiteButton

@Composable
fun InicioLoginScreen(navController: NavController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(
            ...
            Column(
                ...
                WhiteButton("Entrar", handleCLick = ({navController.navigate("login")}))
                NucleoTextButton("Ainda não tem uma conta?", Color.White, onClick = {navController.navigate("sem_conta")})
            }
...
@Composable
fun inicioLoginScreenPreview() {
    NucleoFornariTheme {
        InicioLoginScreen(navController = rememberNavController())
    }
}